                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="inputRadio" id="macho" value="macho"
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="inputRadio" id="femea" value="femea"
                                v-model="sexo">
